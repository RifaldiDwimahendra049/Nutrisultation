				...
				<form name="konsultasi" method="post">
                            <div class="row gy-3 gy-4">
                                <div class="data">
                                    ...
                                    <input readonly type="text"placeholder="Umur (Tahun)" name="umur" value="<?= $umur; ?> Tahun">

                                    <div class="flexy">
                                    <div class="flex">
                                    <input readonly type="text"  placeholder="Tinggi badan (CM)" name="tinggi" value="<?php echo $tinggi; ?> CM">
                                    </div>
                                    <div class="flex">
                                    <input readonly type="text" placeholder="Berat badan (KG)" name="berat" value="<?php echo $berat; ?> KG">
                                    </div>
                                    </div>
