	...
	<div class="dashboard">
			<div class="navi">
				<ul>
					...
					<li class="active"><a class="hidup" href="konsultasi_nutri.php">Konsultasi</a></li>
            ...
            $data = mysqli_query($connect,"SELECT * FROM konsultasi WHERE nutrisionist='$kosong' ");
            $jumlah_data = mysqli_num_rows($data);
            $total_halaman = ceil($jumlah_data / $batas);

            $data_user = mysqli_query($connect,"SELECT * FROM konsultasi WHERE nutrisionist='$kosong' LIMIT $halaman_awal, $batas ");
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $keterangan; ?></td>
                                            <td><a href="respon.php?id=<?php echo $item['id']?>" class="btn-iya">Respon</a></td>
                                        </tr>
                                    <?php $no++;
                                    endforeach; 
