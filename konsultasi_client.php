	...
	<div class="dashboard">
			<div class="navi">
				<ul>
					...
					<li class="active"><a class="hidup" href="konsultasi_client.php">Data Konsultasi anda</a></li>
            ...
            $data = mysqli_query($connect,"SELECT * FROM konsultasi WHERE email='$email' ");
            $jumlah_data = mysqli_num_rows($data);
            $total_halaman = ceil($jumlah_data / $batas);

            $data_user = mysqli_query($connect,"SELECT * FROM konsultasi WHERE email='$email' LIMIT $halaman_awal, $batas ");
			...
			<div class="isi-data">
				<h2 class="heading">Data Konsultasi  anda</h2>
				<table class="table1">
					<thead>
						<tr>
							<th>No</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $keterangan; ?></td>
                                            <td><a href="detail_konsultasi.php?id=<?php echo $item['id']?>" class="btn-iya">Detail</a></td>
                                             <td><a href="cetak.php?id=<?php echo $item['id']?>" class="btn-cetak">Cetak</a></td>
                                        </tr>
                                    <?php $no++;
                                    endforeach; 
